...
class TC004002(unittest.TestCase):
    ...
    def test_t_c004002(self):
        ...
        driver.find_element(By.XPATH, "//div[@id='widget-navbar-217834']/ul/li[6]/ul/li[6]/a/div/span").click()
        ...
        driver.find_element(By.ID, "input-email").send_keys("alextisgona@gmail.com")
        driver.find_element(By.ID, "input-password").click()
        driver.find_element(By.ID, "input-password").clear()
        driver.find_element(By.ID, "input-password").send_keys("@@@123abc")
