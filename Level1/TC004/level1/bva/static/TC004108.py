...
class TC004108(unittest.TestCase):
    def setUp(self):
    ...
    def test_t_c004108(self):
        ...
        driver.find_element(By.ID, "input-password").send_keys("pppppppppppppppppppppppppppppppppppppppppppppppppp")
